        ...
        for i_test_batch, test_batch in enumerate(self._dataset_test):
            ...
            for j in range(numobjects):
                ...
                for k in range(howmanysamples):
                    ...
                    interpenetration = self.get_interpenetration(verts[:100], test_batch['3d_points_object'][0], test_batch['3d_faces_object'][0])
                    interpenetration = interpenetration + self.get_interpenetration(verts[100:200], test_batch['3d_points_object'][0], test_batch['3d_faces_object'][0])
                    interpenetration = interpenetration + self.get_interpenetration(verts[200:300], test_batch['3d_points_object'][0], test_batch['3d_faces_object'][0])
                    interpenetration = interpenetration + self.get_interpenetration(verts[300:400], test_batch['3d_points_object'][0], test_batch['3d_faces_object'][0])
                    interpenetration = interpenetration + self.get_interpenetration(verts[400:500], test_batch['3d_points_object'][0], test_batch['3d_faces_object'][0])
                    interpenetration = interpenetration + self.get_interpenetration(verts[500:600], test_batch['3d_points_object'][0], test_batch['3d_faces_object'][0])
                    interpenetration = interpenetration + self.get_interpenetration(verts[600:700], test_batch['3d_points_object'][0], test_batch['3d_faces_object'][0])
                    interpenetration = interpenetration + self.get_interpenetration(verts[700:], test_batch['3d_points_object'][0], test_batch['3d_faces_object'][0])
            ...
            for j in range(len(hand_Ts)):
                ...
                points_3d, _ = self._model._MANO(torch.cat((R, HR), -1), th_trans=T)
            ...
            img = plot_utils.render_hand_objects_on_img(np.float32(previous_verts), np.int32(previous_faces), np.float32(all_verts), np.int32(all_faces), self._model._input_fullsize_img[0], self._model._input_cam_intrinsics[0])

            print("RENDERING VIDEO")
            cv2.imwrite('results_2021/img_%d.png'%i_test_batch, img[:,:,::-1])
